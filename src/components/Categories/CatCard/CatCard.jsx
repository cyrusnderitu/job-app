...
const CatCard = ({icon, title}) => {
  return (
    <div className='px-6 py-10 shadow-2xl bg-slate-600 text-white hover:text-slate-400 hover:bg-lime-200 hover:cursor-pointer hover:translate-y-4 transition'>
