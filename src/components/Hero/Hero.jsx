...
const Hero = () => {
  return (
    <div className="h-screen flex justify-center items-center">
      <div className="hero_cont w-full grid gap-y-8 mt-20">
        <div className="top flex flex-col items-center text-center">
          <div className="w-[60%]">
            ...
            <p className="desc text-gray-400">
              ...
              you're searchin for, and we'll find your job
            </p>
        ...
        <div className="bottom flex items-center justify-center gap-8">
          <img src={C1} alt="" className="h-[200px] w-fit bg-cyan-300 rounded-lg pt-10 px-7"/>
          <div className="flex flex-col gap-y-4 justify-center items-center">
            <img src={C2} alt="" className="h-[200px] w-fit bg-purple-500 rounded-lg pt-10 px-7"/>
            <img src={C3} alt="" className="h-[200px] w-fit bg-yellow-200 rounded-lg pt-10 px-7"/>
          </div>
          <img src={C4} alt="" className="h-[200px] w-fit bg-cyan-300 rounded-lg pt-10 px-7"/>
          <div className="flex flex-col gap-y-4 justify-center items-center">
            <img src={C5} alt="" className="h-[200px] w-fit bg-orange-400 rounded-lg pt-10 px-4"/>
            <img src={C6} alt="" className="h-[200px] w-fit bg-lime-300 rounded-lg pt-10 px-7"/>
          </div>
          <img src={C8} alt="" className="h-[200px] w-fit bg-red-300 rounded-lg pt-10 px-7"/>
        </div>
      </div>
    </div>
  );
